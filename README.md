...
[![Stars](https://img.shields.io/github/stars/TeamUltroid/Ultroid?style=flat-square&color=yellow)]([https://github.com/TeamUltroid](https://github.com/Sumitmeena12/Ultroid)/Ultroid/stargazers)
...
- Fill your details in a `.env` file, as given in [`.env.sample`](https://github.com/Sumitmeena12/Ultroid/Ultroid/blob/main/.env.sample).
